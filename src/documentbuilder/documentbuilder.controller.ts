...
export class DocumentbuilderController {
  ...
  @Post()
  create(
    @Body() createDocumentbuilderDto: CreateDocumentbuilderDto,
    @Req() req: any,
  ) {
    return this.documentbuilderService.create(
  ...
  update(
    @Param("id") id: string,
    @Body() updateDocumentbuilderDto: UpdateDocumentbuilderDto,
    @Req() req: any,
  ) {
    return this.documentbuilderService.update(
      id,
