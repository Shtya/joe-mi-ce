...
export class SalesTargetController {
  constructor(
    readonly salesTargetService: SalesTargetService,
  ...
  async getStatistics(@Req() req: any, @Query("branchId") branchId?: string) {
    ...
    return await this.salesTargetService.getSalesTargetStatistics(
      projectId,
      branchId,
    );
  }
